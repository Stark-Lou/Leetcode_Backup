...
//        printPicWords(N7);
        ...
        switch (op){
            ...
            case "-":result=num1-num2;break;
            case "*":result=num1*num2;break;
            case "/":result=num1/num2;break;  //todo 处理小数点问题
        }
    ...
    private static ArrayList format(String s){
        ...
        for(char c:chars){
            switch (c){
                case '0':list.add(N0);break;
                case '1':list.add(N1);break;
                case '2':list.add(N2);break;
                case '3':list.add(N3);break;
                case '4':list.add(N4);break;
                case '5':list.add(N5);break;
                case '6':list.add(N6);break;
                case '7':list.add(N7);break;
                case '8':list.add(N8);break;
                case '9':list.add(N9);break;
                case '+':list.add(OP_ADD);break;
                case '-':list.add(OP_MIN);break;
                case '*':list.add(OP_MULT);break;
                case '/':list.add(OP_DIV);break;
                case '=':list.add(OP_EQ);break;
            }
        }
        return list;
    }
